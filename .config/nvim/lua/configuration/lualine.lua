return {
  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd({ "DirChanged", "BufEnter", "FocusGained" }, {
      callback = function() vcs_cache = { result = nil, cwd = nil, vcs_type = nil } end,
    })
    ...
    local function get_search_count()
      ...
      if result.total > 0 then return " " .. result.current .. "/" .. result.total end
      return ""
    end
    ...
    vim.api.nvim_create_autocmd("ColorScheme", {
      callback = function() colors = load_colors() end,
    })
    ...
    require("lualine").setup({
      ...
      sections = {
        ...
        lualine_c = {
          {
            ...
            source = function()
              ...
              if summary then
                return { added = summary.added or 0, modified = summary.modified or 0, removed = summary.removed or 0 }
              end
              return nil
            end,
        ...
        lualine_x = {
          ...
          {
            function() return _G.LspStatus and _G.LspStatus() or "" end,
            icon = " ",
            color = { fg = colors.blue, bg = colors.gray },
            separator = { left = pill_left, right = "" },
            cond = function() return _G.LspStatus and _G.LspStatus() ~= "" end,
            padding = { left = 1, right = 1 },
          },
        },
        lualine_y = {
