return {
  ...
  config = function()
    ...
    local oxlint_root_files = { "oxlintrc.json", ".oxlintrc.json", ".oxlintrc" }
    ...
    local function read_package_json(bufnr)
      ...
      if not ok or type(package) ~= "table" then return nil end
      return package
    end
    ...
    local function has_oxc_package(bufnr)
      ...
      local dependency_keys = { "dependencies", "devDependencies", "peerDependencies", "optionalDependencies" }
